...
Button(text="logistika").grid(row=4,column=1)
Button(text="Programeriumine").grid(row=4,column=1)
Button(text="Inglih").grid(row=4,column=1)
Button(text="Rakendus").grid(row=4,column=1)
Button(text="Четверг:").grid(row=4,column=1)
Button(text="Четверг:").grid(row=4,column=1)
root.mainloop()